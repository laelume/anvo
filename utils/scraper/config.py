...
def show_help():
    ...
    help_text = """
scrap.py - Animal Vocalization Scraper
=========================================
...
EXAMPLES:
    python scrap.py -s "kiwi" -q A -l 10
    python scrap.py --species "owl" --limit unlimited --quality B
    python scrap.py -s "Corvus" -q A -l 20 -d 2
    python scrap.py -s "cardinal" -d 0.5
    python scrap.py -s "eagle" -o "raptors" -q B
...
Scientific Name Search:
    python scrap.py -s "Corvus" -q A -l 20
...
Multiple Filters:
    python scrap.py -s "warbler" -q A -l 15 -d 3 -b "bird_sounds"
    # 15 excellent warbler recordings, max 3 minutes, in bird_sounds directory

Any Quality, Any Duration:
    python scrap.py -s "loon" -l unlimited -d unlimited
...
def main():
    ...
    if not args.species:
        ...
        print("\nQuick example:")
        print("python scrap.py -s 'kiwi' -q A")
        return
    ...
    try:
        ...
        # Download sounds
        print(f"scrap.py - Downloading {args.species} sounds...")
        print("=" * 50)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        print("scrap.py - Animal Vocalization Scraper")
