...
def scrape(source: str, species: str, quality: Optional[str] = None,
    ...
    for recording in recordings:
        if source_obj.download(recording, download_dir):
            downloaded_count += 1
    ...
    print(f"\nDownload complete! Saved {downloaded_count} files to: {clickable_path}")
